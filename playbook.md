...
GOVERN 1.5 Ongoing monitoring and periodic review of the risk management process and its outcomes are planned, organizational roles and responsibilities are clearly defined, including determining the frequency of periodic review.
...
## 4
GOVERN 4.1 Organizational policies, and practices are in place to foster a critical thinking and safety-first mindset in the design, development, deployment, and uses of AI systems to minimize
negative impacts.
...
integrate feedback from those external to the team that developed or deployed the AI system regarding the potential individual and societal impacts related to AI risks.
GOVERN 5.2 Mechanisms are established to enable AI actors to regularly incorporate adjudicated
...
MANAGE 4.3 Incidents and errors are communicated to relevant AI actors including affected
communities. Processes for tracking, responding to, and recovering from incidents and errors are followed and documented.
...
MAP 1.3 The organization’s mission and relevant goals for the AI technology are understood and documented.
...
MAP 2.1 The specific task, and methods used to implement the task, that the AI system will support
...
MAP 5.1  Likelihood and magnitude of each identified impact (both potentially beneficial and harmful) based on expected use, past uses of AI systems in similar contexts, public incident reports, feedback from those external to the team that developed or deployed the AI system,
or other data are identified and documented.
MAP 5.2 Practices and personnel for supporting regular engagement with relevant AI actors and
integrating feedback about positive, negative, and unanticipated impacts are in place and documented.
...
MEASURE 1.3 Internal experts who did not serve as front-line developers for the system and/or independent assessors are involved in regular assessments and updates. Domain experts,
users, AI actors external to the team that developed or deployed the AI system, and affected
communities are consulted in support of assessments as necessary per organizational risk tolerance.
...
MEASURE 2.9 The AI model is explained, validated, and documented, and AI system output is interpreted within its context – as identified in the MAP function – and to inform responsible use and governance.
...
track existing, unanticipated, and emergent AI risks based on factors such as intended and actual performance in deployed contexts.
...
* fairness
	...
	* inclusivity
* maintainability?
* appealability/contestability?

# 
**

Takeaways from session by Nonprofit Data Network: AI in nonprofits 
...
- How do you see AI transforming the way nonprofits deliver impact.

The non profits believe that the development of AI is often driven by the pursuit of profit. Its most suitable to be consumed by organisations that wish to reduce labor costs and increase revenue. The physical and human-centered nature of nonprofit work makes it hard to imagine AI significantly transforming core services. There is interest in its potential to streamline grant-making and reporting, with initiatives like GrantOps mentioned as an example. Other AI services that are seen as beneficial include: Scheduling, data cleaning, and email management.

Some sources: 
https://ssir.org/articles/entry/artificial-intelligence-donor-engagement

https://cep.org/report-backpacks/ai-with-purpose-how-foundations-and-nonprofits-are-thinking-about-and-using-artificial-intelligence/?section=overview#overview

https://www.nonprofitpro.com/article/2025-ai-benchmark-report-how-artificial-intelligence-is-changing-the-nonprofit-sector/

https://www.bridgespan.org/insights/exploring-ai-opportunities-for-nonprofits-and-the-social-sector



- What ethical or trust-related challenges do you anticipate when integrating AI into nonprofit work?
    

The non profits seek strong policies to be in place to ensure data privacy. Most of their data is sensitive and they can’t risk getting it exposed. They lack tech expertise to guide safe and responsible use.  They fear that risks associated with AI services will be more difficult to be identified than other technologies for their staff.

Upskilling and AI adoption takes a lot of thought and effort which may disrupt day to day operations.

Some highlighted that AI apps are western centric, largely tailored to meet the needs of English-speaking consumers, reinforcing systemic inequities.

There was also a concern regarding hidden environmental and financial costs (GPUs need to be replaced after 4-5 years, the overall cost of energy consumption will increase even for the domestic use)

Data governance isnt effectively ensuring proper use of data as the organisations treat them as a one-time effort, but it needs to be revisited over time.

  
  

- What support would make AI adoption easier for your organization? 
    

The non profits seek strong foundational policies and accessible AI resources. 

AI development isnt focussed on supporting nonprofits so they see lesser opportunities of adoption.

The most highlighted were the security risks. 

While self-service tools exist, using them remains a challenge as the teams are not sure about the safety risks.

They look for business maturity before diving into AI maturity.

They emphasized the need for more funding to invest in AI adoption and upskilling. 

Standout quotes

"There's an excitement about adoption but a concern about the potential cost (privacy and security)."

"We are not the buyers, so we don’t dictate what's created. We just use what's available"

# Comment

Non-profits need practitioners, who are trained, licensed and insured, to assume responsibility for the outcomes of the deployment of AI systems. Much like doctors who prescribe medication that is both a remedy for the right person, in the right context and also a poison in the wrong dose, a φάρμακον (pharmacon).
