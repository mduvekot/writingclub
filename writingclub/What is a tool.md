...
A tool cannot be replaced unless it is a specific.

Software applications are not tools. You can substitute Excel with Google Sheets or Numbers or Open Office. They're the supposedly the same thing, just from a different vendor. But if you know how to use one, you do not know how to use the other.  

But a Bostich Framing nailer is almost the same as a Metabo, or a Paslode, or a Milwaukee. Even if one is pneumatic, the other cordless and another gas-powered, it takes no effort to switch between them.

A tool is so narrowly defined by its use that variation is almost non-existent. Sure, I might prefer a Stiletto hammer to an Estwing, but they are completely equivalent on the job. I can replace one with the other instantly and not experience any delay or other difficulty on the job.  
...
Per Carus: A tool is any implement employed for rendering work effective. 
...
Electrical cooking appliances—..including coffee percolators, toasters, chafing dishes, [etc.]. Maclean's February 163/1
### Carus vs. Heidegger

- **Carus:** Tools converge toward prototypes because there is a most efficient way to perform the act. The prototype embodies the essence of the activity.
- **Heidegger:** Tools uncover the world by withdrawing into use. Their essence is not efficiency but their role in a network of practices. 
...
* [Paul Carus, _The Philosophy of the Tool_ (1893)](https://archive.org/details/philosophytool00carugoog)
* https://www.researchgate.net/publication/289154561_Using_ontological_dependence_to_distinguish_between_hardware_and_software
* https://archive.org/details/philosophytool00carugoog
* https://www.cambridge.org/core/services/aop-cambridge-core/content/view/B8FCA7B69D6E74F25E55438718AF9873/S0031824825000212a.pdf/tool_use_beyond_humans.pdf
* 
